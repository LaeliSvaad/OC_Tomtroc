    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="/">
                <div class="my-navbar-brand">
                    <img class="logo" src="<?= \App\Utils\Url::to('assets/images/logo_tomtroc.png') ?>" alt="logo tomtroc">
        ...
        <ul class="nav navbar-nav navbar-right">
            <?php if (isset($_SESSION['user'])): ?>
                ...
                <li>
                    <a class="nav-link <?php echo ($current_page === 'logout') ? 'active' : ''; ?>" href="<?= \App\Utils\Url::to('deconnexion') ?>">Déconnexion</a>
                </li>
            <?php else: ?>
                <li>
